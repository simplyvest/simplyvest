...
function TokenIcon({ name, iconUrl }: { name: string; iconUrl?: string }) {
  ...
  return (
    <div className="flex h-7 w-7 items-center justify-center rounded-full bg-field text-xs font-semibold text-muted">
...
export function TokenRow({
  ...
  return (
    <button
      ...
      className={cn(
        "flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left transition-colors hover:bg-field",
