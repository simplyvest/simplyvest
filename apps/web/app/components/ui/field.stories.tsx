...
export const WithSelect: Story = {
  args: {
    label: "Country",
    children: (
      <select className="flex h-9 w-full rounded-md border border-border2 bg-bg1 px-3 py-1 text-sm text-text shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-text placeholder:text-muted focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-sol disabled:cursor-not-allowed disabled:opacity-50 aria-[invalid=true]:border-warn aria-[invalid=true]:ring-warn">
