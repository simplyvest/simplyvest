...
| `PRIVY_APP_ID`                 | No       | Privy application ID (JWT auth — required if using auth middleware)     |
| `PRIVY_APP_SECRET`             | No       | Privy application secret (JWT auth — required if using auth middleware) |
